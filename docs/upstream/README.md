> Archived documentation for **Sprite Fusion Pixel Snapper**, the upstream engine
> by Hugo Duprez. The Aseprite extension maintained in this fork is documented in
> the [repository README](../../README.md).
>
> Source: [upstream commit ae20461](https://github.com/Hugo-Dz/spritefusion-pixel-snapper/blob/ae20461f60fb39e75d15f184bab1ebec1219511c/README.md).
> The original content below is preserved; only relative image paths have been
> adjusted for this directory. Product links, illustrations, CLI instructions,
> and WASM examples below describe the upstream project.
